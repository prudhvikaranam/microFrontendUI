            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = options;
                        return [4 /*yield*/, options.bootstrapFunction(props)];
                    case 1:
                        // We call `bootstrapFunction()` inside the bootstrap lifecycle hook
                        // because Angular modules that expose custom elements should be
                        // bootstrapped only once.
                        _a.ngModuleRef = _b.sent();
                        return [2 /*return*/];
                }
            });
        });
    ...
    function mount(options, props) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                containerElement = internals.getContainerElementAndSetTemplate(options, props);
...
//# sourceMappingURL=single-spa-angular-elements.umd.js.map
